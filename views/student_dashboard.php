...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark tsu-navbar mb-4">
      <div class="container">
        <a class="navbar-brand" href="#"><img src="<?php echo BASE_URL; ?>/assets/images/logo.png" alt="TSU"> Student Portal</a>
        ...
        <?php
            ...
            if (count($upcoming) > 0) {
                ...
                foreach ($upcoming as $up) {
                    ...
                    echo "<li><a href='" . BASE_URL . "/student/assessment?id={$up['assessment_id']}' class='text-decoration-none fw-bold text-dark'>{$up['course_code']} - {$up['assessment_title']}</a>: Scheduled for $date ({$up['timer_minutes']} minutes)</li>";
                }
                echo '</ul></div>';
            }
        ?>
                        ...
                        if (count($modules) > 0) {
                            ...
                            foreach ($modules as $m) {
                                ...
                                if ($grade) {
                                    ...
                                    echo '<a href="' . BASE_URL . '/student/module?id='.$m['id'].'" class="btn btn-sm btn-outline-success">View Notes & Assessments</a>';
                                }
                                echo '</li>';
                            }
                            echo '</ul>';
                            ...
                            foreach ($assessments as $a) {
                                ...
                                if ($grade) {
                                    ...
                                    if ($is_disabled || $is_expired) {
                                        ...
                                        echo '<a href="' . BASE_URL . '/student/assessment?id='.$a['id'].'" class="btn btn-sm btn-tsu-accent text-dark fw-bold">Take Assessment</a>';
                                    }
                                }
                                echo '</li>';
                            }

                    ...
                    foreach ($courses as $index => $c) {
                        ...
                        <div class="row mb-4">
                            <div class="col-md-4 border-end">
                                ...
                                <form action="/CMP_Course_Module/src/process_markdown.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-4 border-end">
                                ...
                                <form id="aiGenForm_'.$c['id'].'" action="/CMP_Course_Module/src/process_markdown_raw.php" method="POST">
                                    <input type="hidden" name="course_id" value="'.$c['id'].'">
                            ...
                            <div class="col-md-4">
                                ...
                                <form action="/CMP_Course_Module/src/process_course_pdfs.php" method="POST" enctype="multipart/form-data">
                                    <input type="hidden" name="course_id" value="'.$c['id'].'">
                                    <div class="mb-2">
                        ...
                        if (count($modules) > 0) {
                            echo '<div class="d-flex justify-content-between align-items-center bg-light p-2 rounded mb-2 border">
                                    ...
                                    <div>
                                        <a href="/CMP_Course_Module/src/export_course.php?course_id='.$c['id'].'&format=md" class="btn btn-sm btn-outline-secondary me-1" title="Export as Markdown">Download .md</a>
                                        <a href="/CMP_Course_Module/src/export_course.php?course_id='.$c['id'].'&format=pdf" target="_blank" class="btn btn-sm btn-outline-dark me-3" title="Export as PDF">Print / Save PDF</a>
                                        <form action="/CMP_Course_Module/src/delete_module.php" method="POST" class="d-inline" onsubmit="return confirm(\'Are you sure you want to delete ALL modules for this course? This will also wipe related assessments and grades.\');">
                            ...
                            foreach ($modules as $m) {
                                ...
                                echo '<div>
                                        <form action="/CMP_Course_Module/src/toggle_module.php" method="POST" class="d-inline me-1">
                                        ...
                                        <a href="/CMP_Course_Module/facilitator/module?id='.$m['id'].'" class="btn btn-sm btn-outline-primary me-1">Manage</a>
                                        <form action="/CMP_Course_Module/src/delete_module.php" method="POST" class="d-inline" onsubmit="return confirm(\'Are you sure you want to delete this module and its assessments?\');">
                        ...
                        if (count($students) > 0) {
                            ...
                            <div class="mb-3 d-flex justify-content-between align-items-center">
                                ...
                                <form action="/CMP_Course_Module/src/unenroll.php" method="POST" onsubmit="return confirm(\'Unenroll ALL students?\');">
                            ...
                            <form action="/CMP_Course_Module/src/unenroll.php" method="POST">
                            ...
                            foreach ($assessments as $a) {
                                ...
                                echo '<tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="/CMP_Course_Module/src/toggle_scores.php" method="POST" class="d-inline me-1">
                                                <input type="hidden" name="assessment_id" value="'.$a['id'].'">
                                            ...
                                            <form action="/CMP_Course_Module/src/delete_assessment.php" method="POST" class="d-inline" onsubmit="return confirm(\'Cancel and delete this assessment?\');">
                                                <input type="hidden" name="assessment_id" value="'.$a['id'].'">
                                                <input type="hidden" name="course_id" value="'.$c['id'].'">
                        ...
                        <div class="card bg-light shadow-sm">
                            <div class="card-body">
                                ...
                                <hr>
                                <form id="saveAssmtForm_'.$c['id'].'" action="/CMP_Course_Module/src/save_assessment.php" method="POST">
                                    <input type="hidden" name="course_id" value="'.$c['id'].'">

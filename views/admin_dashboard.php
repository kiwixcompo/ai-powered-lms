                            ...
                            if (count($courses_full) > 0) {
                                foreach ($courses_full as $cf) {
                                    ...
                                    echo '<tr>
                                        ...
                                        <td>
                                            <a href="/CMP_Course_Module/src/export_course.php?course_id='.$cf['id'].'&format=pdf" target="_blank" class="btn btn-sm btn-outline-danger">Export PDF</a>
                                            <a href="/CMP_Course_Module/src/export_course.php?course_id='.$cf['id'].'&format=md" class="btn btn-sm btn-outline-secondary">Export MD</a>
                                        </td>
                                    </tr>';
                                }
                            } else {
        ...
        <div class="accordion shadow-sm" id="adminAccordion">
                    ...
                    <div class="accordion-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 border-end">
                                ...
                                <form action="/CMP_Course_Module/src/add_single_student.php" method="POST">
                                    <div class="mb-2">
                            ...
                            <div class="col-md-6">
                                ...
                                <form action="/CMP_Course_Module/src/upload_students.php" method="POST" enctype="multipart/form-data">
                                    <div class="mb-2">
            ...
            <div class="accordion-item">
                ...
                <div id="collapseEnrollment" class="accordion-collapse collapse" aria-labelledby="headingEnrollment" data-bs-parent="#adminAccordion">
                    <div class="accordion-body">
                        ...
                        <form action="/CMP_Course_Module/src/enroll_category.php" method="POST">
                            <div class="row mb-3">
                                <div class="col-md-5">
            ...
            <div class="accordion-item">
                ...
                <div id="collapseCourses" class="accordion-collapse collapse" aria-labelledby="headingCourses" data-bs-parent="#adminAccordion">
                    <div class="accordion-body">
                        <form action="/CMP_Course_Module/src/create_course.php" method="POST">
                            <div class="row mb-3">
                                <div class="col-md-3">
                    ...
                    <div class="accordion-body">
                        <div class="row">
                            <div class="col-md-6 border-end">
                                ...
                                <form action="/CMP_Course_Module/src/create_facilitator.php" method="POST">
                            ...
                            <div class="col-md-6">
                                ...
                                <form action="/CMP_Course_Module/src/assign_facilitator.php" method="POST">
                                    <div class="mb-2">

  ...
  <div class="container">
    <a class="navbar-brand" href="#">Course Admin</a>
      ...
      <ul class="navbar-nav ms-auto">
        <li class="nav-item"><a class="nav-link" href="<?php echo BASE_URL; ?>/facilitator">Dashboard</a></li>
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-4">
            <div class="card h-100">
                ...
                <div class="card-body">
                    <form id="saveContentForm" action="<?php echo BASE_URL; ?>/src/save_module_content.php" method="POST">
        ...
        <div class="col-md-6 mb-4">
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo BASE_URL; ?>/src/upload_module_pdf.php" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="module_id" value="<?= $module['id'] ?>">
                        <div class="mb-3">
                    ...
                    <form action="' . BASE_URL . '/src/disable_pdf_mode.php" method="POST" class="mt-3" onsubmit="return confirm('Switch back to Markdown mode?');">
                        <input type="hidden" name="module_id" value="<?= $module['id'] ?>">
